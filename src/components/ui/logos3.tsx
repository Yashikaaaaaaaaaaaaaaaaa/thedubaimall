  ...
  logos = [
    {
      id: "logo-1",
      description: "Logo 1",
      image: "https://cdn.freebiesupply.com/logos/thumbs/1x/chanel-2-logo.png",
      className: "h-7 w-auto",
    },
    {
      id: "logo-2",
      description: "Logo 2",
      image: "https://www.logo.wine/a/logo/Louis_Vuitton/Louis_Vuitton-Logo.wine.svg",
      className: "h-7 w-auto",
    },
    {
      id: "logo-3",
  ...
  return (
    <section className="pb-0 pt-0">
      <div className="container flex flex-col items-center text-center mx-auto px-4">
        <h2 className="mb-6 mt-0 text-2xl font-bold text-pretty lg:text-4xl text-foreground">
          {heading}
        </h2>
      </div>
